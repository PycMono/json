...
function ctCopyToClipboard(text) {
  ...
  p.then(function () {
    ...
    if (typeof gaTrackResultCopy === 'function') gaTrackResultCopy('color-tools', 'color_value');
  }).catch(function () {
...
function ctRandomColor() {
  ...
  if (typeof gaTrackToolUse === 'function') gaTrackToolUse('color-tools');
}
...
function ctGeneratePalette() {
  ...
  ctRenderPaletteBar();
  ctUpdateUrlHash();
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('color-tools', count, 0);
}
...
function ctDrawWheelHarmony() {
  ...
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('color-tools', genColors.length, 0);
}
...
function ctCalcContrast() {
  ...
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('color-tools', 1, 0);
}
...
function ctInitGradient() {
  ...
  ctUpdateGradient();
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('color-tools', State.gradient.stops.length, 0);
}
...
function ctCopyGradientCss() {
  ...
  if (el) {
    ctCopyToClipboard(el.textContent);
    if (typeof gaTrackResultCopy === 'function') gaTrackResultCopy('color-tools', 'gradient_css');
  }
}
...
function ctSimulateBlindness() {
  ...
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('color-tools', hexList.length, 0);
}
...
function ctGenTailwind() {
  ...
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('color-tools', steps.length, 0);
}
...
function ctCopyTwConfig() {
  ...
  if (el) {
    ctCopyToClipboard(el.textContent);
    if (typeof gaTrackResultCopy === 'function') gaTrackResultCopy('color-tools', 'tailwind_config');
  }
}
...
function ctOpenExportModal() {
  ...
  if (typeof gaTrackExport === 'function') gaTrackExport('color-tools', 'css');
}
...
function ctSwitchExportTab(fmt) {
  ...
  if (typeof gaTrackExport === 'function') gaTrackExport('color-tools', fmt);
}
...
function ctCopyExportCode() {
  ...
  if (el) {
    ctCopyToClipboard(el.textContent);
    if (typeof gaTrackResultCopy === 'function') gaTrackResultCopy('color-tools', 'export_' + (State.ui.exportFormat || 'text'));
  }
}
