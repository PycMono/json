...
function processJson() {
  ...
  if (typeof gaTrackToolUse === 'function') gaTrackToolUse('json-tool-validate');
  ...
  try {
    ...
    setOutput('');
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('json-tool-validate', 1, Date.now() - _gaStart);
  }
}
