...
async function loadServices() {
  ...
  try {
    ...
    if (typeof gaTrackError === 'function') gaTrackError('sms-buy', 'load_services_failed', err.message);
  } finally {
...
function selectService(service) {
  ...
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('sms-buy', 1, 0);
}
...
async function loadCountries(serviceName) {
  ...
  try {
    ...
    if (typeof gaTrackError === 'function') gaTrackError('sms-buy', 'load_countries_failed', err.message);
  } finally {
...
async function loadOperators(serviceName, countryCode) {
  ...
  try {
    ...
    if (typeof gaTrackError === 'function') gaTrackError('sms-buy', 'load_operators_failed', err.message);
  } finally {
