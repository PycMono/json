...
function renderMarkdown() {
  ...
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('tools-markdown', 1, 0);
}
...
document.getElementById('copyMdBtn')?.addEventListener('click', function () {
  navigator.clipboard.writeText(editor.value).then(() => {
    ...
    if (typeof gaTrackResultCopy === 'function') gaTrackResultCopy('tools-markdown', 'text');
  });
});
