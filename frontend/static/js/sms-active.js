...
async function loadActiveOrders() {
  if (typeof gaTrackToolInteraction === 'function') gaTrackToolInteraction('sms-active', 'refresh');
  try {
...
async function cancelActiveOrder(orderId) {
  ...
  if (typeof gaTrackFormSubmit === 'function') gaTrackFormSubmit('cancel_order', 'sms-active');
  try {
    ...
    if (typeof gaTrackError === 'function') gaTrackError('sms-active', 'cancel_fail', err.message);
  }
}

async function finishActiveOrder(orderId) {
  if (typeof gaTrackFormSubmit === 'function') gaTrackFormSubmit('finish_order', 'sms-active');
  try {
    ...
    if (typeof gaTrackError === 'function') gaTrackError('sms-active', 'finish_fail', err.message);
  }
}
...
function copyActiveNumber(number, btn) {
  navigator.clipboard.writeText(number.replace(/\s/g, '')).then(() => {
    ...
    if (typeof gaTrackResultCopy === 'function') gaTrackResultCopy('sms-active', 'text');
