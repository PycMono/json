  ...
  el.innerHTML = `
    ...
    <div class="jt-options-row">
      ...
      <label style="margin-left:12px">
        <span class="jt-options-label">数组长度:</span>
...
function processJson() {
  ...
  if (typeof gaTrackToolUse === 'function') gaTrackToolUse('json-tool-json-generator');
  clearErrorPanel();
  ...
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('json-tool-json-generator', 1, Date.now() - _gaStart);
