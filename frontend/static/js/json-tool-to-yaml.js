...
function processJson() {
  ...
  if (typeof gaTrackToolUse === 'function') gaTrackToolUse('json-tool-to-yaml');
  clearErrorPanel();
  ...
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('json-tool-to-yaml', 1, Date.now() - _gaStart);
