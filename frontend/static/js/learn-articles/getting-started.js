...
<ul>
  <li><a href="/json/pretty">json JSON Formatter</a> — format, validate, and explore JSON in browser</li>
...
<h2>在线 JSON 查看器</h2>
<ul>
  <li><a href="/json/pretty">json JSON 格式化工具</a> — 在浏览器中格式化、验证和探索 JSON</li>
