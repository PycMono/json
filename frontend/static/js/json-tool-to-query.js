...
function processJson() {
  ...
  if (typeof gaTrackToolUse === 'function') gaTrackToolUse('json-tool-to-query');
  clearErrorPanel();
  ...
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('json-tool-to-query', 1, Date.now() - _gaStart);
