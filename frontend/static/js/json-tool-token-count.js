...
function initToolOptions() {
  ...
  target.innerHTML =
    ...
    '<select id="tokenModel" class="jt-options-select jt-options-select" onchange="updateCostPreview()">' +
...
async function processJson() {
  ...
  if (typeof gaTrackToolUse === 'function') gaTrackToolUse('json-tool-token-count');
  clearErrorPanel();
