...
function processJson() {
  ...
  if (typeof gaTrackToolUse === 'function') gaTrackToolUse('json-tool-from-yaml');
  clearErrorPanel();
  ...
  try {
    ...
    setOutput('', 'plaintext');
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('json-tool-from-yaml', 1, Date.now() - _gaStart);
  }
}
