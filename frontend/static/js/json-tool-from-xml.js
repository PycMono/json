...
function processJson() {
  ...
  if (typeof gaTrackToolUse === 'function') gaTrackToolUse('json-tool-from-xml');
  clearErrorPanel();
  ...
  try {
    ...
    setOutput('', 'plaintext');
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('json-tool-from-xml', 1, Date.now() - _gaStart);
  }
}
