...
async function startResize() {
  ...
  if (typeof gaTrackToolUse === 'function') gaTrackToolUse('img-resize');
  ...
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('img-resize', resizedResults.length, Date.now() - _gaStart);
...
function downloadSingle(idx) {
  ...
  if (!result) return;
  if (typeof gaTrackDownload === 'function') gaTrackDownload('img-resize', 'image/jpeg');
...
async function downloadAll() {
  ...
  if (typeof gaTrackDownload === 'function') gaTrackDownload('img-resize', 'application/zip');
