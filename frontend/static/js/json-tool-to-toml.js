...
function processJson() {
  ...
  if (typeof gaTrackToolUse === 'function') gaTrackToolUse('json-tool-to-toml');
  clearErrorPanel();
  ...
  try {
    ...
    setOutput(toml, 'toml');
  if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('json-tool-to-toml', 1, Date.now() - _gaStart);
