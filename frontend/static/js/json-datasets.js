...
var DS = (function () {
  ...
  function init() {
    ...
    if (typeof gaTrackToolUse === 'function') gaTrackToolUse('json-datasets');
    ...
    if (typeof gaTrackProcessDone === 'function') gaTrackProcessDone('json-datasets', 1, Date.now() - _gaStart);
  ...
  function downloadDataset(slug) {
    ...
    fetch(STATIC_BASE + slug + '.json')
      ...
      .then(function (blob) {
        ...
        if (typeof gaTrackDownload === 'function') gaTrackDownload('json-datasets', 'json');
