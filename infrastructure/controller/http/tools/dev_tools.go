...
func DevHashPage(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"Canonical":   "https://ycjson.top/dev/hash",
		"HreflangZH":  "https://ycjson.top/dev/hash?lang=zh",
		"HreflangEN":  "https://ycjson.top/dev/hash?lang=en",
...
func DevHashGuidePage(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"Canonical":   "https://ycjson.top/dev/hash-guide",
		"HreflangZH":  "https://ycjson.top/dev/hash-guide?lang=zh",
		"HreflangEN":  "https://ycjson.top/dev/hash-guide?lang=en",
		"OGImage":     "https://ycjson.top/static/img/og.png",
...
func DevBase64Page(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"Canonical":   "https://ycjson.top/dev/base64",
		"HreflangZH":  "https://ycjson.top/dev/base64?lang=zh",
		"HreflangEN":  "https://ycjson.top/dev/base64?lang=en",
		"OGImage":     "https://ycjson.top/static/img/og.png",
...
func DevURLEncodePage(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"Canonical":   "https://ycjson.top/dev/url-encode",
		"HreflangZH":  "https://ycjson.top/dev/url-encode?lang=zh",
		"HreflangEN":  "https://ycjson.top/dev/url-encode?lang=en",
		"OGImage":     "https://ycjson.top/static/img/og.png",
...
func DevIPPage(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"Canonical":   "https://ycjson.top/dev/ip",
		"HreflangZH":  "https://ycjson.top/dev/ip?lang=zh",
		"HreflangEN":  "https://ycjson.top/dev/ip?lang=en",
		"OGImage":     "https://ycjson.top/static/img/og.png",
...
func DevWhoisPage(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"Canonical":   "https://ycjson.top/dev/whois",
		"HreflangZH":  "https://ycjson.top/dev/whois?lang=zh",
		"HreflangEN":  "https://ycjson.top/dev/whois?lang=en",
		"OGImage":     "https://ycjson.top/static/img/og.png",
...
func DevWhoisGuidePage(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"Canonical":   "https://ycjson.top/dev/whois-guide",
		"HreflangZH":  "https://ycjson.top/dev/whois-guide?lang=zh",
		"HreflangEN":  "https://ycjson.top/dev/whois-guide?lang=en",
		"OGImage":     "https://ycjson.top/static/img/og.png",
...
func DevWordCounterPage(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"Canonical":   "https://ycjson.top/dev/word-counter",
		"HreflangZH":  "https://ycjson.top/dev/word-counter?lang=zh",
		"HreflangEN":  "https://ycjson.top/dev/word-counter?lang=en",
		"OGImage":     "https://ycjson.top/static/img/og.png",
...
func DevUUIDPage(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"Canonical":   "https://ycjson.top/dev/uuid",
		"HreflangZH":  "https://ycjson.top/dev/uuid?lang=zh",
		"HreflangEN":  "https://ycjson.top/dev/uuid?lang=en",
		"OGImage":     "https://ycjson.top/static/img/og.png",
...
func DevLoremPage(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"Canonical":   "https://ycjson.top/dev/lorem",
		"HreflangZH":  "https://ycjson.top/dev/lorem?lang=zh",
		"HreflangEN":  "https://ycjson.top/dev/lorem?lang=en",
		"OGImage":     "https://ycjson.top/static/img/og.png",
...
func DevAESPage(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"Canonical":   "https://ycjson.top/dev/aes",
		"HreflangZH":  "https://ycjson.top/dev/aes?lang=zh",
		"HreflangEN":  "https://ycjson.top/dev/aes?lang=en",
		"OGImage":     "https://ycjson.top/static/img/og.png",
...
func DevHTMLEntitiesPage(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"Canonical":   "https://ycjson.top/dev/html-entities",
		"HreflangZH":  "https://ycjson.top/dev/html-entities?lang=zh",
		"HreflangEN":  "https://ycjson.top/dev/html-entities?lang=en",
		"OGImage":     "https://ycjson.top/static/img/og.png",
...
func DevUserAgentPage(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"Canonical":   "https://ycjson.top/dev/user-agent",
		"HreflangZH":  "https://ycjson.top/dev/user-agent?lang=zh",
		"HreflangEN":  "https://ycjson.top/dev/user-agent?lang=en",
		"OGImage":     "https://ycjson.top/static/img/og.png",
...
func DevUserAgentGuidePage(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"Canonical":   "https://ycjson.top/dev/user-agent-guide",
		"HreflangZH":  "https://ycjson.top/dev/user-agent-guide?lang=zh",
		"HreflangEN":  "https://ycjson.top/dev/user-agent-guide?lang=en",
		"OGImage":     "https://ycjson.top/static/img/og.png",
...
func DevDiffPage(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"Canonical":   "https://ycjson.top/dev/diff",
		"HreflangZH":  "https://ycjson.top/dev/diff?lang=zh",
		"HreflangEN":  "https://ycjson.top/dev/diff?lang=en",
		"OGImage":     "https://ycjson.top/static/img/og.png",
