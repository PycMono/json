...
func DetectorAcademicPage(c *gin.Context) {
	...
	canonical := "https://toolboxnova.com/ai/detector/for-academic-writing"
	if lang != "en" && lang != "" {
		canonical = fmt.Sprintf("https://toolboxnova.com/ai/detector/for-academic-writing?lang=%s", lang)
	}

	hreflang := map[string]string{
		"en":  "https://toolboxnova.com/ai/detector/for-academic-writing?lang=en",
		"zh":  "https://toolboxnova.com/ai/detector/for-academic-writing?lang=zh",
		"ja":  "https://toolboxnova.com/ai/detector/for-academic-writing?lang=ja",
		"ko":  "https://toolboxnova.com/ai/detector/for-academic-writing?lang=ko",
		"spa": "https://toolboxnova.com/ai/detector/for-academic-writing?lang=spa",
	}
	...
	data := render.BaseData(c, gin.H{
		...
		"OGImage":        "https://toolboxnova.com/static/img/og-detector-academic.png",
		"FreeWordLimit":  15000,
