...
func ArticleRewriterPage(c *gin.Context) {
	...
	canonical := "https://toolboxnova.com/ai/article-rewriter"
	if lang != "en" && lang != "" {
		canonical = fmt.Sprintf("https://toolboxnova.com/ai/article-rewriter?lang=%s", lang)
	}

	hreflang := map[string]string{
		"en":  "https://toolboxnova.com/ai/article-rewriter?lang=en",
		"zh":  "https://toolboxnova.com/ai/article-rewriter?lang=zh",
		"ja":  "https://toolboxnova.com/ai/article-rewriter?lang=ja",
		"ko":  "https://toolboxnova.com/ai/article-rewriter?lang=ko",
		"spa": "https://toolboxnova.com/ai/article-rewriter?lang=spa",
	}
	...
	data := render.BaseData(c, gin.H{
		...
		"OGImage":        "https://toolboxnova.com/static/img/og-article-rewriter.png",
		"FreeWordLimit":  15000,
