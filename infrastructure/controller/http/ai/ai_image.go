...
func AIImagePage(c *gin.Context) {
	...
	data := render.BaseData(c, gin.H{
		...
		"ActiveTool":  "ai-image",
		"JSONLD":      jsonld,
		"Canonical":   "https://ycjson.top/ai/image",
		"HreflangZH":  "https://ycjson.top/ai/image?lang=zh",
		"HreflangEN":  "https://ycjson.top/ai/image?lang=en",
		"HreflangJA":  "https://ycjson.top/ai/image?lang=ja",
		"HreflangKO":  "https://ycjson.top/ai/image?lang=ko",
		"HreflangSPA": "https://ycjson.top/ai/image?lang=spa",
...
func AIImageLandingPage(c *gin.Context) {
			...
			map[string]interface{}{
				...
				"itemListElement": []interface{}{
					map[string]interface{}{
						...
						"position": 1,
						"name":     "Home",
						"item":     "https://ycjson.top/",
					},
					map[string]interface{}{
						"@type":    "ListItem",
						"position": 2,
						"name":     "AI Tools",
						"item":     "https://ycjson.top/ai/humanizer",
					},
					map[string]interface{}{
						"@type":    "ListItem",
						"position": 3,
						"name":     t("ai-image.landing.seo.title"),
						"item":     "https://ycjson.top/ai/image-generator",
					},
				},
			},
			map[string]interface{}{
				...
				"url":                    "https://ycjson.top/ai/image-generator",
				"offers":                 map[string]interface{}{"@type": "Offer", "price": "0", "priceCurrency": "USD"},
	...
	data := render.BaseData(c, gin.H{
		...
		"JSONLD":      jsonld,
		"FAQs":        faqs,
		"Canonical":   "https://ycjson.top/ai/image-generator",
		"HreflangZH":  "https://ycjson.top/ai/image-generator?lang=zh",
		"HreflangEN":  "https://ycjson.top/ai/image-generator?lang=en",
		"HreflangJA":  "https://ycjson.top/ai/image-generator?lang=ja",
		"HreflangKO":  "https://ycjson.top/ai/image-generator?lang=ko",
		"HreflangSPA": "https://ycjson.top/ai/image-generator?lang=spa",
