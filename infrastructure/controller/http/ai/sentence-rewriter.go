...
func SentenceRewriterPage(c *gin.Context) {
	...
	canonical := "https://ycjson.top/ai/sentence-rewriter"
	if lang != "en" && lang != "" {
		canonical = fmt.Sprintf("https://ycjson.top/ai/sentence-rewriter?lang=%s", lang)
	}

	hreflang := map[string]string{
		"en":  "https://ycjson.top/ai/sentence-rewriter?lang=en",
		"zh":  "https://ycjson.top/ai/sentence-rewriter?lang=zh",
		"ja":  "https://ycjson.top/ai/sentence-rewriter?lang=ja",
		"ko":  "https://ycjson.top/ai/sentence-rewriter?lang=ko",
		"spa": "https://ycjson.top/ai/sentence-rewriter?lang=spa",
	}
	...
	data := render.BaseData(c, gin.H{
		...
		"OGImage":        "https://ycjson.top/static/img/og-sentence-rewriter.png",
		"FreeWordLimit":  15000,
