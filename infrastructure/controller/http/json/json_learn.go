...
var seoTitles = map[string]string{
	"en":  "JSON Learning Hub — 53+ Free Tutorials | json",
	"zh":  "JSON 学习中心 — 53+ 篇免费教程 | json",
	"ja":  "JSON学習ハブ — 53以上の無料チュートリアル | json",
	"ko":  "JSON 학습 허브 — 53개 이상의 무료 튜토리얼 | json",
	"spa": "Centro de Aprendizaje JSON — Más de 53 Tutoriales Gratuitos | json",
}
